#/dATa gEt
    ...
    execute store result score @s tec_bonus run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.status.tec
    ...
    execute store result score @s conc_bonus run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.status.conc
#エンチャント
    execute store result score @s atk_enchant run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.Enchantbuff.atk
    execute store result score @s mag_enchant run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.Enchantbuff.mag
    execute store result score @s tec_enchant run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.Enchantbuff.tec
    execute store result score @s max_hp_enchant run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.Enchantbuff.hp
    execute store result score @s int_enchant run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.Enchantbuff.int
    execute store result score @s def_enchant run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.Enchantbuff.def
    execute store result score @s spd_enchant run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.Enchantbuff.spd
    execute store result score @s crt_enchant run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.Enchantbuff.crt
    execute store result score @s luk_enchant run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.Enchantbuff.luk
    execute store result score @s conc_enchant run data get entity @s Inventory[{Slot:103b}].tag.Customnbt.Enchantbuff.conc
#合計
