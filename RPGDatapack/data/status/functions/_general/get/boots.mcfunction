#/dATa gEt
    ...
    execute store result score @s spd_bonus run data get entity @s Inventory[{Slot:100b}].tag.Customnbt.status.spd
    execute store result score @s crt_bonus run data get entity @s Inventory[{Slot:100b}].tag.Customnbt.status.crt
    execute store result score @s luk_bonus run data get entity @s Inventory[{Slot:100b}].tag.Customnbt.status.luk
    execute store result score @s conc_bonus run data get entity @s Inventory[{Slot:100b}].tag.Customnbt.status.conc
#エンチャント
    ...
    execute store result score @s spd_enchant run data get entity @s Inventory[{Slot:100b}].tag.Customnbt.Enchantbuff.spd
    execute store result score @s crt_enchant run data get entity @s Inventory[{Slot:100b}].tag.Customnbt.Enchantbuff.crt
    execute store result score @s luk_enchant run data get entity @s Inventory[{Slot:100b}].tag.Customnbt.Enchantbuff.luk
    execute store result score @s conc_enchant run data get entity @s Inventory[{Slot:100b}].tag.Customnbt.Enchantbuff.conc
#合計
