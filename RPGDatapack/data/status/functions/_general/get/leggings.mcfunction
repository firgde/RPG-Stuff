#/dATa gEt
    ...
    execute store result score @s dex_bonus run data get entity @s Inventory[{Slot:101b}].tag.Customnbt.status.dex
...
#エンチャント
    ...
    execute store result score @s dex_enchant run data get entity @s Inventory[{Slot:101b}].tag.Customnbt.Enchantbuff.dex
