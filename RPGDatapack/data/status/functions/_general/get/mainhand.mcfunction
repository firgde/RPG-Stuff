#/dATa gEt
    execute store result score @s atk_bonus run data get entity @s SelectedItem.tag.Customnbt.status.atk
    execute store result score @s mag_bonus run data get entity @s SelectedItem.tag.Customnbt.status.mag
    execute store result score @s tec_bonus run data get entity @s SelectedItem.tag.Customnbt.status.tec
    execute store result score @s max_hp_bonus run data get entity @s SelectedItem.tag.Customnbt.status.hp
    execute store result score @s int_bonus run data get entity @s SelectedItem.tag.Customnbt.status.int
    execute store result score @s def_bonus run data get entity @s SelectedItem.tag.Customnbt.status.def
    execute store result score @s spd_bonus run data get entity @s SelectedItem.tag.Customnbt.status.spd
...
#エンチャント
    ...
    execute store result score @s tec_enchant run data get entity @s SelectedItem.tag.Customnbt.Enchantbuff.tec
