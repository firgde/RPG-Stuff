...
#Mobｻﾓｫｫｫｫﾝ
    execute as @e[tag=spawner,distance=..10,nbt={Item:{tag:{Type:"zombie"}}}] run function mobs:summon/dummy_zombie
    execute as @e[tag=spawner,distance=..10,nbt={Item:{tag:{Type:"skeleton"}}}] run function mobs:summon/dummy_skeleton
#リセット
