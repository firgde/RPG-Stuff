...
# 落下ダメージ処理
    execute at @p as @e[distance=..50,type=!#main:non_mob] unless data entity @s {fall_distance:0.0f} store result score @s fall_distance run data get entity @s fall_distance
