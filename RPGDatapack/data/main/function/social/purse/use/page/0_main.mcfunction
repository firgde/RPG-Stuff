...
# /itemたくさん
    ...
    item replace entity @s container.12 with stick[tooltip_display={hide_tooltip:true},item_model="air",custom_data={ui:1b,menu:"purse"}]
    ...
    item replace entity @s container.18 with stick[tooltip_display={hide_tooltip:true},item_model="air",custom_data={ui:1b,menu:"purse"}]
