# シュルカーボックスにアイテムを避難させた後、棒を入れる
    ...
    execute if score @s page matches 2 if score @s sub_page matches 0 run scoreboard players set #gem_type buffer 20
    execute if score @s sub_page matches 1 run scoreboard players add #gem_count buffer 1
