# シュルカーボックスにアイテムを避難させた後、棒を入れる
    ...
    execute if score @s page matches 2 if score @s sub_page matches 0 run scoreboard players set #moneyamount buffer 10
    execute if score @s sub_page matches 1 run scoreboard players remove #moneycount buffer 1
