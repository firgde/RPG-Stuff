# シュルカーボックスにアイテムを避難させた後、棒を入れる
    ...
    execute if score @s page matches 4 run function main:social/knowledge_book/use/page/4_status_combat/place_from_temp {index:13,slot:13}
    execute if score @s page matches 5 run function main:social/knowledge_book/use/page/5_status_explore/place_from_temp {index:13,slot:13}
    execute if score @s page matches 6 run function main:social/knowledge_book/use/page/6_status_collect/place/from_temp {index:13,slot:13}
    execute if score @s page matches 7 run item replace entity @s container.13 with stick[item_model="air",tooltip_display={hide_tooltip:true},custom_data={ui:1b,menu:"knowledge_book"}]
    execute if score @s page matches 71 run function main:social/knowledge_book/use/page/7.1_status_craft_crafting/place_from_temp {index:13,slot:13}
    execute if score @s page matches 72 run function main:social/knowledge_book/use/page/7.2_status_craft_enchantment/place_from_temp {index:13,slot:13}
    execute if score @s page matches 73 run function main:social/knowledge_book/use/page/7.3_status_craft_brewing/place_from_temp {index:13,slot:13}
    execute if score @s page matches 74 run function main:social/knowledge_book/use/page/7.4_status_craft_alchemy/place_from_temp {index:13,slot:13}
    execute if score @s page matches 8 run function main:social/knowledge_book/use/page/8_status_social/place_from_temp {index:13,slot:13}
# ページがマッチするならアクション
    execute if score @s page matches 0 run function main:social/knowledge_book/use/page/2_quests/init
