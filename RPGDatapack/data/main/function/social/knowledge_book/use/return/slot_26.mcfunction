# シュルカーボックスにアイテムを避難させた後、棒を入れる
    ...
    execute if score @s page matches 1 as @a[limit=1] run loot replace entity @e[tag=knowledge_book,distance=..5] container.26 loot main:social/ui/knowledge_book/1_status/money
