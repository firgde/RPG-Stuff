# アイテム返還
    execute unless items entity @s container.14 *[custom_data~{ui:1b}] run item replace entity @a[limit=1] player.cursor from entity @s container.14
# 中身リセット
    data remove entity @s Items
# ページ移動
    scoreboard players set @s page 73
