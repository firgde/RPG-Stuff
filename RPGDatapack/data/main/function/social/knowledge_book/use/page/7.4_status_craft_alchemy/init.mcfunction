# アイテム返還
    execute unless items entity @s container.16 *[custom_data~{ui:1b}] run item replace entity @a[limit=1] player.cursor from entity @s container.16
# 中身リセット
    data remove entity @s Items
# ページ移動
    scoreboard players set @s page 74
...
# レシピ情報
    function main:social/knowledge_book/use/page/7.4_status_craft_alchemy/load_page
# 音
