...
# 演出
    ...
    execute if score #damage_type buffer matches 1 run playsound entity.firework_rocket.large_blast hostile @p ~ ~ ~ 0.5 1
    execute if score #damage_type buffer matches 3 run playsound block.grass.break hostile @p ~ ~ ~ 0.5 1.2
    execute if score #damage_type buffer matches 4 run playsound item.trident.hit hostile @p ~ ~ ~ 0.5 1
    execute if score #damage_type buffer matches 11 run playsound block.gravel.break hostile @p ~ ~ ~ 0.5 0.5
    execute if score #damage_type buffer matches 11 run playsound entity.firework_rocket.large_blast hostile @p ~ ~ ~ 1.5 0.5
# 貫通防止
