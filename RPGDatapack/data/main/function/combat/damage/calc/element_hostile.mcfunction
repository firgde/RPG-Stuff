# デバフを持ってくる
    ...
    execute store result score #main_element buff_timer_element on attacker run data get entity @s equipment.mainhand.components."minecraft:custom_data".Element.Debuff.Timer
    #オフハンドも
    ...
    execute store result score #side_element buff_timer_element on attacker run data get entity @s equipment.offhand.components."minecraft:custom_data".Element.Debuff.Timer
# 合計
