...
# 通知
    tellraw @s {"translate": "combat.text.ability.use","with":[{"nbt": "SelectedItem.components.\"minecraft:custom_data\".Ability.Name","entity":"@a","interpret": true,"color": "aqua","bold": true}]}
# リセット
