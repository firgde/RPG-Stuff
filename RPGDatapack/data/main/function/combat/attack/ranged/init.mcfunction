...
# デバフ
    ...
    execute store result score #side_element buff_amount run data get entity @p Inventory[{Slot:-106b,components:{"minecraft:custom_data":{offhandOnly:1b}}}].components."minecraft:custom_data".Element.Debuff.Amount
    execute store result score #side_element buff_timer run data get entity @p Inventory[{Slot:-106b,components:{"minecraft:custom_data":{offhandOnly:1b}}}].components."minecraft:custom_data".Element.Debuff.Timer
