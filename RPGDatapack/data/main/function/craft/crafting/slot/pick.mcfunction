# item_displayからインベントリにアイテムを持ってくる
    ...
    execute unless score #success_1 buffer matches -2147483648..2147483647 unless items entity @s weapon.mainhand * run item replace entity @p weapon.mainhand from block 0 -59 0 container.0
# リセット
