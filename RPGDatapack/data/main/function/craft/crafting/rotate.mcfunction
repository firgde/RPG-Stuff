# 真ん中のinteractionをプレイヤーに向ける
    execute as @n[tag=slot.4,tag=crafting] at @s facing entity @p eyes run tp @s ~ ~ ~ ~ 0
...
# 真ん中のinteraction以外のタグをつけ直す
    ...
    execute at @e[tag=slot.4,distance=..5] positioned ^-0.2 ^ ^0.2 run tag @n[tag=crafting] add slot.0
    execute at @e[tag=slot.4,distance=..5] positioned ^ ^ ^0.2 run tag @n[tag=crafting] add slot.1
    execute at @e[tag=slot.4,distance=..5] positioned ^0.2 ^ ^0.2 run tag @n[tag=crafting] add slot.2
    execute at @e[tag=slot.4,distance=..5] positioned ^-0.2 ^ ^ run tag @n[tag=crafting] add slot.3
    execute at @e[tag=slot.4,distance=..5] positioned ^0.2 ^ ^ run tag @n[tag=crafting] add slot.5
    execute at @e[tag=slot.4,distance=..5] positioned ^-0.2 ^ ^-0.2 run tag @n[tag=crafting] add slot.6
    execute at @e[tag=slot.4,distance=..5] positioned ^ ^ ^-0.2 run tag @n[tag=crafting] add slot.7
    execute at @e[tag=slot.4,distance=..5] positioned ^0.2 ^ ^-0.2 run tag @n[tag=crafting] add slot.8
