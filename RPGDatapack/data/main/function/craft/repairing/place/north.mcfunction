...
# 修理対象アイテム
    summon item_display ~0.5 ~1.01 ~0.5 {Tags:["repair_item","repair_slot.summon"],Rotation:[90f,90f]}
...
# 修理素材
    summon item_display ~0.5 ~1.04 ~0.8 {Tags:["repair_material","repair_slot.summon"],Rotation:[90f,90f]}
    execute positioned ~0.5 ~1.04 ~0.8 run data modify entity @n[tag=repair_material] transformation.scale set value [0.25f,0.25f,0.25f]
    execute positioned ~0.5 ~1.04 ~0.8 run data modify entity @n[tag=repair_material] transformation.translation set value [0.0f,0.0f,-0.04f]
    summon item_display ~0.5 ~1.04 ~0.5 {Tags:["repair_material","repair_slot.summon"],Rotation:[90f,90f]}
    ...
    summon item_display ~0.5 ~1.04 ~0.2 {Tags:["repair_material","repair_slot.summon"],Rotation:[90f,90f]}
    execute positioned ~0.5 ~1.04 ~0.2 run data modify entity @n[tag=repair_material] transformation.scale set value [0.25f,0.25f,0.25f]
    execute positioned ~0.5 ~1.04 ~0.2 run data modify entity @n[tag=repair_material] transformation.translation set value [0.0f,0.0f,-0.04f]
