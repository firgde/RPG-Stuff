...
# 修理対象アイテム
    summon item_display ~0.5 ~1.01 ~0.5 {Tags:["repair_item"],Rotation:[0f,90f]}
...
# 修理素材
    summon item_display ~0.8 ~1 ~0.5 {Tags:["repair_material"],Rotation:[0f,90f]}
    execute positioned ~0.8 ~1 ~0.5 run data modify entity @n[tag=repair_material] transformation.scale set value [0.25f,0.25f,0.25f]
    execute positioned ~0.8 ~1 ~0.5 run data modify entity @n[tag=repair_material] transformation.translation set value [0.0f,0.0f,-0.04f]
    summon item_display ~0.5 ~1 ~0.5 {Tags:["repair_material"],Rotation:[0f,90f]}
    ...
    summon item_display ~0.2 ~1 ~0.5 {Tags:["repair_material"],Rotation:[0f,90f]}
    execute positioned ~0.2 ~1 ~0.5 run data modify entity @n[tag=repair_material] transformation.scale set value [0.25f,0.25f,0.25f]
    execute positioned ~0.2 ~1 ~0.5 run data modify entity @n[tag=repair_material] transformation.translation set value [0.0f,0.0f,-0.04f]
