...
# 修理対象アイテム
    summon item_display ~0.5 ~1.01 ~0.5 {Tags:["repair_item","repair_slot.summon"],Rotation:[180f,90f]}
...
# 修理素材
    summon item_display ~0.8 ~1.04 ~0.5 {Tags:["repair_material","repair_slot.summon"],Rotation:[180f,90f]}
    ...
    summon item_display ~0.5 ~1.04 ~0.5 {Tags:["repair_material","repair_slot.summon"],Rotation:[180f,90f]}
    ...
    summon item_display ~0.2 ~1.04 ~0.5 {Tags:["repair_material","repair_slot.summon"],Rotation:[180f,90f]}
