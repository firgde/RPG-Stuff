# item_displayからインベントリにアイテムを持ってくる
    ...
    #そしてアイテム還元
    execute as @p if items entity @s weapon.mainhand * run loot give @s mine 0 -59 0 mainhand
    execute as @p unless items entity @s weapon.mainhand * run item replace entity @s weapon.mainhand from block 0 -59 0 container.0
# リセット
