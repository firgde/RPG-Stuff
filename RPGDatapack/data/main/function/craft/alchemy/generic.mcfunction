# アイテムの種類
    ...
    execute unless data entity @n[tag=alchemy.item.0] item.components."minecraft:custom_data"{weapon:1b} store result score #weaponType buffer run data get entity @n[tag=alchemy.item.1] item.components."minecraft:custom_data".weaponType
# 属性
