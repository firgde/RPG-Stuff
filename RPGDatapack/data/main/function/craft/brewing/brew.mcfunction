...
# 結合結果を見て醸造台&item_displayのポーション置き換え
    ...
    execute at @e[tag=brewing.this] run item replace entity @n[tag=brewing.slot.0] contents with potion[item_model="asset:brewing_stand_potion"]
    ...
    execute at @e[tag=brewing.this] run item replace entity @n[tag=brewing.slot.1] contents with potion[item_model="asset:brewing_stand_potion"]
    ...
    execute at @e[tag=brewing.this] run item replace entity @n[tag=brewing.slot.2] contents with potion[item_model="asset:brewing_stand_potion"]
