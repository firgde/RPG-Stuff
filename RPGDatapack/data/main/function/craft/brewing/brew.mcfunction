...
# 結合結果を見て醸造台&item_displayのポーション置き換え
    ...
    execute at @e[tag=brewing.this] run item replace entity @e[tag=brewing.slot.0,limit=1,sort=nearest] contents with potion[custom_model_data=1]
    execute at @e[tag=brewing.this] run data modify entity @e[tag=brewing.slot.0,limit=1,sort=nearest] item.components.CustomPotionColor set from block ~ ~ ~ Items[{Slot:0b}].components.CustomPotionColor
    execute at @e[tag=brewing.this] run item replace entity @e[tag=brewing.slot.1,limit=1,sort=nearest] contents with potion[custom_model_data=1]
    execute at @e[tag=brewing.this] run data modify entity @e[tag=brewing.slot.1,limit=1,sort=nearest] item.components.CustomPotionColor set from block ~ ~ ~ Items[{Slot:1b}].components.CustomPotionColor
    execute at @e[tag=brewing.this] run item replace entity @e[tag=brewing.slot.2,limit=1,sort=nearest] contents with potion[custom_model_data=1]
    execute at @e[tag=brewing.this] run data modify entity @e[tag=brewing.slot.2,limit=1,sort=nearest] item.components.CustomPotionColor set from block ~ ~ ~ Items[{Slot:2b}].components.CustomPotionColor
# 演出
