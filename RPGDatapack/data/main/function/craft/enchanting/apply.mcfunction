...
# 四つのアイテムから候補のプールを作成
    ...
    execute if items block ~ ~ ~ container.4 *[custom_data~{ItemType:1}] if items block ~ ~ ~ container.4 *[custom_data~{weaponType:0}] run data modify storage craft:enchanting temp.item_type set value "sword"
    execute if items block ~ ~ ~ container.4 *[custom_data~{ItemType:1}] if items block ~ ~ ~ container.4 *[custom_data~{weaponType:1}] run data modify storage craft:enchanting temp.item_type set value "hammer"
    execute if items block ~ ~ ~ container.4 *[custom_data~{ItemType:1}] if items block ~ ~ ~ container.4 *[custom_data~{weaponType:2}] run data modify storage craft:enchanting temp.item_type set value "wand"
    execute if items block ~ ~ ~ container.4 *[custom_data~{ItemType:1}] if items block ~ ~ ~ container.4 *[custom_data~{weaponType:3}] run data modify storage craft:enchanting temp.item_type set value "bow"
    execute if items block ~ ~ ~ container.4 *[custom_data~{ItemType:1}] if items block ~ ~ ~ container.4 *[custom_data~{weaponType:4}] run data modify storage craft:enchanting temp.item_type set value "dagger"
    execute if items block ~ ~ ~ container.4 *[custom_data~{ItemType:2}] run data modify storage craft:enchanting temp.item_type set value "accessory"
    execute if items block ~ ~ ~ container.4 *[custom_data~{armor:true}] run data modify storage craft:enchanting temp.item_type set value "armor"
    execute if items block ~ ~ ~ container.4 *[custom_data~{tool:true}] run data modify storage craft:enchanting temp.item_type set value "tool"
