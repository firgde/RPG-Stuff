# アイテム表示処理
    ...
    execute unless data block ~ ~ ~ Items[{Slot:4b}] positioned ~ ~0.5 ~ run item modify entity @n[tag=display_item,distance=..1] contents [{"function":"minecraft:set_components","components":{"minecraft:enchantment_glint_override":false}},{"function":"minecraft:set_item","item":"minecraft:stick"},{"function":"minecraft:set_custom_model_data","value":1}]
# UI処理
