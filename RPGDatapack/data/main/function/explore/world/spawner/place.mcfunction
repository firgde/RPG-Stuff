...
# スポナートロッコを載せたitem_displayを設置
    execute align xyz run summon item_display ~0.5 ~0.3 ~0.5 {Tags:["spawner","spawner.summon"],Passengers:[{id:"spawner_minecart",SpawnCount:1,CustomDisplayTile:1b,DisplayState:{Name:"air"}}],item:{id:"minecraft:stick",count:1,components:{item_model:"air"}}}
