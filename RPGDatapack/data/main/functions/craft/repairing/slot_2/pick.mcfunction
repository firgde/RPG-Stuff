# スロットも手も空の場合や耐久値のあるアイテムを持ってる場合はslot.0にアクセス
    ...
    execute if data entity @s SelectedItem.components."minecraft:custom_data".MaxDurability if entity @s[advancements={main:craft/repairing/slot_2={right=true}}] run advancement grant @s only main:craft/repairing/slot_0 right
# 修復専用アイテムしか置けない
