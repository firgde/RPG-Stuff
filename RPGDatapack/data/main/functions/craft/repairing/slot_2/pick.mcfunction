# スロットも手も空の場合や耐久値のあるアイテムを持ってる場合はslot.0にアクセス
    ...
    execute if data entity @s SelectedItem.tag.Customnbt.MaxDurability if entity @s[advancements={main:craft/repairing/slot_2={right=true}}] run advancement grant @s only main:craft/repairing/slot_0 right
# 修復専用アイテムしか置けない
    execute if data entity @s SelectedItem unless data entity @s SelectedItem.tag{Customnbt:{repairMaterial:1b}} if entity @s[advancements={main:craft/repairing/slot_2={right=true}}] run advancement revoke @s only main:craft/repairing/slot_2
    execute if data entity @s SelectedItem unless data entity @s SelectedItem.tag{Customnbt:{repairMaterial:1b}} if entity @s[advancements={main:craft/repairing/slot_2={right=true}}] run return 0
# slot.2のitem_displayからインベントリにアイテムを持ってくる
    ...
    #左クリックしていたらアイテム消去
    execute if entity @s[advancements={main:craft/repairing/slot_2={left=true}}] at @e[type=interaction,tag=repair_slot.2,limit=1,sort=nearest] run item replace entity @e[limit=1,sort=nearest,tag=repair_material,type=item_display] container.0 with air
    #右クリックしていたら交換
