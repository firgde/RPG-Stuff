# slot.3とmainhandのアイテム交換
    execute at @e[tag=repair_slot.3,limit=1,sort=nearest] run item replace entity @e[limit=1,sort=nearest,tag=repair_material,type=item_display] container.0 from entity @s weapon.mainhand
