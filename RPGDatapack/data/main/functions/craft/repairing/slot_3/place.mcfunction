# slot.3とmainhandのアイテム交換
    ...
    execute at @e[tag=repair_slot.3,limit=1,sort=nearest] run data modify entity @e[limit=1,sort=nearest,tag=repair_material,type=item_display] item.count set value 1
