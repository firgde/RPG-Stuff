...
# 修理素材
    ...
    execute positioned ~0.5 ~1 ~0.8 run data modify entity @e[tag=repair_material,limit=1,sort=nearest] transformation.scale set value [0.25f,0.25f,0.25f]
    execute positioned ~0.5 ~1 ~0.8 run data modify entity @e[tag=repair_material,limit=1,sort=nearest] transformation.translation set value [0.0f,0.0f,-0.04f]
    ...
    execute positioned ~0.5 ~1 ~0.2 run data modify entity @e[tag=repair_material,limit=1,sort=nearest] transformation.scale set value [0.25f,0.25f,0.25f]
    execute positioned ~0.5 ~1 ~0.2 run data modify entity @e[tag=repair_material,limit=1,sort=nearest] transformation.translation set value [0.0f,0.0f,-0.04f]
