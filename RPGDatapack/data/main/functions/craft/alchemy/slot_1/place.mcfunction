# slot.1とmainhandのアイテム交換
    ...
    execute at @e[tag=alchemy.slot.1,limit=1,sort=nearest] run data modify entity @e[limit=1,sort=nearest,tag=alchemy.item,type=item_display] item.count set value 1
