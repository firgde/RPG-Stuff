# アイテムの種類
    execute store result score #weaponType buffer run data get entity @e[tag=alchemy.item.0,limit=1,sort=nearest] item.components.custom_data.weaponType
# 属性
    execute store result score #element0 buffer run data get entity @e[tag=alchemy.item.0,limit=1,sort=nearest] item.components.custom_data.Element.Type
    execute store result score #element1 buffer run data get entity @e[tag=alchemy.item.1,limit=1,sort=nearest] item.components.custom_data.Element.Type
    #両方0または両方0でないなら中止
...
# レア度
    execute store result score #rarity0 buffer run data get entity @e[tag=alchemy.item.0,limit=1,sort=nearest] item.components.custom_data.rarity
    execute store result score #rarity1 buffer run data get entity @e[tag=alchemy.item.1,limit=1,sort=nearest] item.components.custom_data.rarity
