...
# 結合結果を見て醸造台&item_displayのポーション置き換え
    ...
    execute at @e[tag=brewing.this] run item replace entity @e[tag=brewing.slot.0,limit=1,sort=nearest] contents with potion{CustomModelData:1}
    ...
    execute at @e[tag=brewing.this] run item replace entity @e[tag=brewing.slot.1,limit=1,sort=nearest] contents with potion{CustomModelData:1}
    ...
    execute at @e[tag=brewing.this] run item replace entity @e[tag=brewing.slot.2,limit=1,sort=nearest] contents with potion{CustomModelData:1}
