# item_displayからインベントリにアイテムを持ってくる
    ...
    #そしてアイテム還元
    execute unless score #success_1 buffer matches 1 as @p if data entity @s SelectedItem run loot give @s mine 0 -59 0 mainhand
    execute unless score #success_1 buffer matches 1 unless data entity @p SelectedItem run item replace entity @p weapon.mainhand from block 0 -59 0 container.0
# リセット
