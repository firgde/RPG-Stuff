#Slot:7bのエンチャント加算値を取得
    #それぞれのステータス
    execute store result score $ebonusatk buffer run data get block ~ ~-1 ~ Items[{Slot:7b}].tag.Customnbt.EnchantingData.bonus.atk
    execute store result score $ebonusmag buffer run data get block ~ ~-1 ~ Items[{Slot:7b}].tag.Customnbt.EnchantingData.bonus.mag
    execute store result score $ebonusdex buffer run data get block ~ ~-1 ~ Items[{Slot:7b}].tag.Customnbt.EnchantingData.bonus.dex
    execute store result score $ebonushp buffer run data get block ~ ~-1 ~ Items[{Slot:7b}].tag.Customnbt.EnchantingData.bonus.hp
    execute store result score $ebonusint buffer run data get block ~ ~-1 ~ Items[{Slot:7b}].tag.Customnbt.EnchantingData.bonus.int
    execute store result score $ebonusdef buffer run data get block ~ ~-1 ~ Items[{Slot:7b}].tag.Customnbt.EnchantingData.bonus.def
    ...
    execute store result score $eice buffer run data get block ~ ~-1 ~ Items[{Slot:7b}].tag.Customnbt.EnchantingData.bonus.extra.ice
    execute store result score $ethunder buffer run data get block ~ ~-1 ~ Items[{Slot:7b}].tag.Customnbt.EnchantingData.bonus.extra.thunder
    execute store result score $ewind buffer run data get block ~ ~-1 ~ Items[{Slot:7b}].tag.Customnbt.EnchantingData.bonus.extra.wind

    #スキルエンチャントの出やすさ
    execute store result score $eskill buffer run data get block ~ ~-1 ~ Items[{Slot:7b}].tag.Customnbt.EnchantingData.bonus.skill
#加算
