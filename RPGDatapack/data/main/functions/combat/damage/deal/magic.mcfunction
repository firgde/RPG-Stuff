...
# 属性を取得
    execute store result score #mainElement buffer run data get entity @e[tag=magic,sort=nearest,limit=1] item.components."minecraft:custom_data".Element.Type[0]
    execute store result score #sideElement buffer run data get entity @e[tag=magic,sort=nearest,limit=1] item.components."minecraft:custom_data".Element.Type[1]
...
# デバフデータ取得
    execute store result score #mainElement buff_amount run data get entity @e[tag=magic,sort=nearest,limit=1] item.components."minecraft:custom_data".Element.Debuff[0].Amount
    execute store result score #mainElement buff_timer run data get entity @e[tag=magic,sort=nearest,limit=1] item.components."minecraft:custom_data".Element.Debuff[0].Timer
    execute store result score #sideElement buff_amount run data get entity @e[tag=magic,sort=nearest,limit=1] item.components."minecraft:custom_data".Element.Debuff[1].Amount
    execute store result score #sideElement buff_timer run data get entity @e[tag=magic,sort=nearest,limit=1] item.components."minecraft:custom_data".Element.Debuff[1].Timer
# 演出
