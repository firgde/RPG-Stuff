# デバフを持ってくる
    execute store result score $element_mainhand buff_amount run data get entity @p SelectedItem.tag.Customnbt.Element.Debuff.Amount
    execute store result score $element_mainhand buff_timer run data get entity @p SelectedItem.tag.Customnbt.Element.Debuff.Timer
    #オフハンドも
    execute store result score $element_offhand buff_amount run data get entity @p Inventory[{Slot:-106b}].tag.Customnbt.Element.Debuff.Amount
    execute store result score $element_offhand buff_timer run data get entity @p Inventory[{Slot:-106b}].tag.Customnbt.Element.Debuff.Timer
# 合計
