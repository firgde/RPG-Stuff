...
# デバフ
    ...
    execute store result score #sideElement buff_amount run data get entity @p Inventory[{Slot:-106b,components:{custom_data:{offhandOnly:1b}}}].components.custom_data.Element.Debuff.Amount
    execute store result score #sideElement buff_timer run data get entity @p Inventory[{Slot:-106b,components:{custom_data:{offhandOnly:1b}}}].components.custom_data.Element.Debuff.Timer
