...
#±15度に絞る
    execute positioned ^ ^ ^10 as @e[tag=target,distance=..10] positioned ^ ^ ^-10 rotated ~15 ~ positioned ^1000.1 ^ ^ positioned ~ ~-1.6 ~ unless entity @s[distance=..1000] run tag @s remove target
    execute positioned ^ ^ ^10 as @e[tag=target,distance=..10] positioned ^ ^ ^-10 rotated ~-15 ~ positioned ^1000.1 ^ ^ positioned ~ ~-1.6 ~ unless entity @s[distance=..1000] run tag @s remove target
    execute positioned ^ ^ ^10 as @e[tag=target,distance=..10] positioned ^ ^ ^-10 rotated ~ ~15 positioned ^1000.1 ^ ^ positioned ~ ~-1.6 ~ unless entity @s[distance=..1000] run tag @s remove target
    execute positioned ^ ^ ^10 as @e[tag=target,distance=..10] positioned ^ ^ ^-10 rotated ~ ~-15 positioned ^1000.1 ^ ^ positioned ~ ~-1.6 ~ unless entity @s[distance=..1000] run tag @s remove target
#一体に絞る
