#遠距離魔法共通の処理
    ...
    #当たり判定
    execute align xz unless score @s playerID = @e[limit=1,dx=0,team=hostile,type=!player] playerID as @e[limit=1,dx=0,team=hostile,type=!player] positioned ~0.5 ~ ~0.5 run function main:combat/attack/magic/damage
    #タイマー加算
