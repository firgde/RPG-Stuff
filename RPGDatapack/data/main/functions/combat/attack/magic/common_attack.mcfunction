#攻撃の種類で分岐
    ...
    execute if entity @s[tag=magic.thunder] at @s run particle dust 1.000 0.969 0.000 1 ^ ^ ^ 0.05 0.05 0.05 0.5 5 normal
    execute if entity @s[tag=magic.thunder] at @s run particle dust 1 0.984 0.549 1 ^ ^ ^ 0.05 0.05 0.05 0.5 5 normal
    ...
    execute if entity @s[tag=magic.ranged] at @s run function main:combat/attack/magic/ranged/
