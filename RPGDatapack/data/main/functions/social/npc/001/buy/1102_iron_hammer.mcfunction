#実際に取引で買ったアイテムを削除
    clear @s stick{CustomModelData:1102}
#本物のアイテムどうぞ
    execute if score @s money matches 200.. run function items:1102_iron_hammer
#修行...ではなく金が足りぬようだな
...
#リセット
    advancement revoke @s only main:social/buy/id001/1102_iron_hammer
