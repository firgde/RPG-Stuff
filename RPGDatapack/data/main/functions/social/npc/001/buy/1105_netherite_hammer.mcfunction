#実際に取引で買ったアイテムを削除
    clear @s stick{CustomModelData:1105}
#本物のアイテムどうぞ
    execute if score @s money matches 450.. run function items:1105_netherite_hammer
#修行...ではなく金が足りぬようだな
...
#リセット
    advancement revoke @s only main:social/buy/id001/1105_netherite_hammer
