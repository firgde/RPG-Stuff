...
#実際に取引で買ったアイテムを削除
    clear @s stick{CustomModelData:2002}
#本物のアイテムどうぞ
    execute if score @s money matches 200.. run function items:2002_thunder_ring
#修行...ではなく金が足りぬようだな
...
#リセット
    advancement revoke @s only main:social/buy/id002/2002_thunder_ring
