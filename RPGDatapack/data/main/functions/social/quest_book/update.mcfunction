#ステータスの桁数を取得
    ...
    execute if score @s dex_base matches 100.. run data modify storage space: text.dex set value ""
    execute if score @s dex_base matches 10..99 run data modify storage space: text.dex set value ""
    execute if score @s dex_base matches 0..9 run data modify storage space: text.dex set value ""
