#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"blue","translate":"item.netherite_hammer"}'
    data modify storage item: Item.tag.display.Lore set value ['{"translate":"item.netherite_hammer.lore","color":"white","italic":false}','{"translate":"item.netherite_hammer.lore.second","color":"white","italic":false}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 1105
...
#ステータスとレア度、耐久値設定
    scoreboard players set #atkbonus buffer 75
    ...
    scoreboard players set #spdbonus buffer -25
    ...
    scoreboard players set #durability buffer 2300
    scoreboard players set #maxdurability buffer 2300
    scoreboard players set #enchantcount buffer 0
    scoreboard players set #hasskill buffer 0
#実際のステータス
    data modify storage item: Item.tag.Customnbt.status.atk set value 75
    ...
    data modify storage item: Item.tag.Customnbt.status.spd set value -25
    ...
    data modify storage item: Item.tag.Customnbt.Durability set value 2300
    data modify storage item: Item.tag.Customnbt.MaxDurability set value 2300
#共通
