#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"blue","translate":"item.thunder_ring"}'
    data modify storage item: Item.tag.display.Lore set value ['{"translate":"item.thunder_ring.lore","color":"white","italic":false}']
    data modify storage item: Item.tag.Customnbt.display.Lore set value ['{"translate":"item.thunder_ring.lore","color":"white","italic":false}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 2002
    ...
    #魔法専用
    data modify storage item: Item.tag.Customnbt.magicType.Tag set value "magic.thunder"
    data modify storage item: Item.tag.Customnbt.magicType.ArmorItems set value [{},{},{},{id:"minecraft:stick",tag:{CustomModelData:1,CustomDamage:{damageType:"thunder",debuffTimer:100,buffAmount:-10}},Count:1b}]
    ...
    scoreboard players set #element buffer 3
#ステータスとレア度、耐久値設定
