#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"blue","translate":"item.ice_ring"}'
    data modify storage item: Item.tag.display.Lore set value ['{"translate":"item.ice_ring.lore","color":"white","italic":false}']
    data modify storage item: Item.tag.Customnbt.display.Lore set value ['{"translate":"item.ice_ring.lore","color":"white","italic":false}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 2001
    ...
    #魔法専用
    data modify storage item: Item.tag.Customnbt.magicType.Tag set value "magic.ice"
