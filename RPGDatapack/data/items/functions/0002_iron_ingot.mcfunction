#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"green","translate":"item.iron_ingot"}'
    data modify storage item: Item.tag.display.Lore set value ['{"italic":false,"color":"white","translate":"item.iron_ingot.lore"}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 2
    ...
    data modify storage item: Item.tag.Customnbt.id set value "iron_ingot"
#ステータスとレア度、耐久値設定
