#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"red","translate":"item.quest_paper"}'
    data modify storage item: Item.tag.display.Lore set value ['{"italic":false,"color":"white","translate":"item.quest_paper.lore"}']
    #data modify storage item: Item.tag.Customnbt.weaponType set value ""
    scoreboard players set #itemtype buffer 8
    ...
    data modify storage item: Item.tag.CustomModelData set value 8000
    ...
    data modify storage item: Item.tag.Customnbt.id set value "quest_paper"
#ステータスとレア度、耐久値設定
