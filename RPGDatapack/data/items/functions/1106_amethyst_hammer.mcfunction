#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"dark_purple","translate":"item.amethyst_hammer"}'
    data modify storage item: Item.tag.display.Lore set value ['{"translate":"item.amethyst_hammer.lore","color":"white","italic":false}','{"translate":"item.amethyst_hammer.lore.second","color":"white","italic":false}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 1106
    data modify storage item: Item.tag.Damage set value 0
    data modify storage item: Item.tag.AttributeModifiers set value [{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-3.2,Operation:0,UUID:[I;266192592,-932362374,-1729792336,-927508933],Slot:"mainhand"},{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:0,Operation:0,UUID:[I;-1550551712,2138130775,-1688359397,-1103780835],Slot:"mainhand"}]
...
#ステータスとレア度、耐久値設定
    ...
    scoreboard players set #crtbonus buffer 30
    scoreboard players set #lukbonus buffer 15
    scoreboard players set #concbonus buffer 7
    scoreboard players set #rarity buffer 3
    scoreboard players set #durability buffer 2150
    scoreboard players set #maxdurability buffer 2150
...
#実際のステータス
    ...
    data modify storage item: Item.tag.Customnbt.status.crt set value 30
    data modify storage item: Item.tag.Customnbt.status.luk set value 15
    data modify storage item: Item.tag.Customnbt.status.conc set value 7
    data modify storage item: Item.tag.Customnbt.Durability set value 2150
    data modify storage item: Item.tag.Customnbt.MaxDurability set value 2150
#共通
