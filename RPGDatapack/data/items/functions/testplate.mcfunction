#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.Customnbt.armorType set value "chestplate"
...
#ステータスとレア度、耐久値設定
    ...
    scoreboard players set #defbonus buffer 15
...
#実際のステータス
    ...
    data modify storage item: Item.tag.Customnbt.status.def set value 15
