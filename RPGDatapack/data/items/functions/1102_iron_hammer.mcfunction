#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"green","translate":"item.iron_hammer"}'
    data modify storage item: Item.tag.display.Lore set value ['{"translate":"item.iron_hammer.lore","color":"white","italic":false}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 1102
...
#ステータスとレア度、耐久値設定
    scoreboard players set #atkbonus buffer 40
    ...
    scoreboard players set #durability buffer 300
    scoreboard players set #maxdurability buffer 300
    scoreboard players set #enchantcount buffer 0
    scoreboard players set #hasskill buffer 0
#実際のステータス
    data modify storage item: Item.tag.Customnbt.status.atk set value 40
    ...
    data modify storage item: Item.tag.Customnbt.Durability set value 300
    data modify storage item: Item.tag.Customnbt.MaxDurability set value 300
#共通
