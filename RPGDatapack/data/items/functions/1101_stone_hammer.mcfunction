#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"white","translate":"item.stone_hammer"}'
    data modify storage item: Item.tag.display.Lore set value ['{"translate":"item.stone_hammer.lore","color":"white","italic":false}','{"translate":"item.stone_hammer.lore.second","color":"white","italic":false}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 1101
...
#ステータスとレア度、耐久値設定
    scoreboard players set $atkbonus buffer 32
    ...
    scoreboard players set $durability buffer 150
    scoreboard players set $maxdurability buffer 150
    scoreboard players set $enchantcount buffer 0
    scoreboard players set $hasskill buffer 0
#実際のステータス
    data modify storage item: Item.tag.Customnbt.status.atk set value 32
    ...
    data modify storage item: Item.tag.Customnbt.Durability set value 150
    data modify storage item: Item.tag.Customnbt.MaxDurability set value 150
#共通
