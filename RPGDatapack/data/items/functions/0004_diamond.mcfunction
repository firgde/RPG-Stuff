#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"blue","translate":"item.diamond"}'
    data modify storage item: Item.tag.display.Lore set value ['{"italic":false,"color":"white","translate":"item.diamond.lore"}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 4
    ...
    data modify storage item: Item.tag.Customnbt.id set value "diamond"
#ステータスとレア度、耐久値設定
