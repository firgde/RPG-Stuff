#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"green","translate":"item.golden_dagger"}'
    data modify storage item: Item.tag.display.Lore set value ['{"translate":"item.golden_dagger.lore","color":"white","italic":false}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 1403
    data modify storage item: Item.tag.Damage set value 0
    data modify storage item: Item.tag.AttributeModifiers set value [{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:0.3,Operation:0,UUID:[I;266192592,-932362374,-1729792336,-927508933],Slot:"mainhand"},{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:10.19,Operation:0,UUID:[I;-1550551712,2138130775,-1688359397,-1103780835],Slot:"mainhand"}]
...
#ステータスとレア度、耐久値設定
    scoreboard players set #atkbonus buffer 10
...
#実際のステータス
    data modify storage item: Item.tag.Customnbt.status.atk set value 10
