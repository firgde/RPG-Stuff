#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"blue","translate":"item.diamond_wand"}'
    data modify storage item: Item.tag.display.Lore set value ['{"translate":"item.diamond_wand.lore","color":"white","italic":false}']
    data modify storage item: Item.tag.Customnbt.display.Lore set value ['{"translate":"item.diamond_wand.lore","color":"white","italic":false}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 1204
    ...
    data modify storage item: Item.tag.Customnbt.magicType.CoolDown set value 20
    data modify storage item: Item.tag.Customnbt.magicType.display.Time set value "1"
    data modify storage item: Item.tag.Customnbt.magicType.display.CoolDown set value "1"
#ステータスとレア度、耐久値設定
    scoreboard players set #atkbonus buffer 0
    scoreboard players set #magbonus buffer 30
    ...
    scoreboard players set #durability buffer 500
    scoreboard players set #maxdurability buffer 500
    scoreboard players set #enchantcount buffer 0
    scoreboard players set #hasskill buffer 0
    scoreboard players set #mprequire buffer 20
#実際のステータス
    data modify storage item: Item.tag.Customnbt.status.atk set value 0
    data modify storage item: Item.tag.Customnbt.status.mag set value 30
    ...
    data modify storage item: Item.tag.Customnbt.Durability set value 500
    data modify storage item: Item.tag.Customnbt.MaxDurability set value 500
    data modify storage item: Item.tag.Customnbt.mpRequire set value 20
#共通
