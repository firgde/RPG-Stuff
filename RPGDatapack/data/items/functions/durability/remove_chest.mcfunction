# custom_dataの耐久値を減算
    execute store result score @s durability run data get entity @s Inventory[{Slot:102b}].components."minecraft:custom_data".Durability
...
# アイテムの耐久ゲージを更新
    execute store result score @s maxDurability run data get entity @s Inventory[{Slot:102b}].components."minecraft:custom_data".MaxDurability
