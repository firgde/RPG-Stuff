#名前だとか説明文だとか
    ...
    data modify storage item: Item.id set value "minecraft:written_book"
    ...
    data modify storage item: Item.tag.CustomModelData set value 9999
...
#本なので色々設定
    data modify storage item: Item.tag.title set value ""
    data modify storage item: Item.tag.author set value ""
    data modify storage item: Item.tag.resolved set value 0b
#共通
