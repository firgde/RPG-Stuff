#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"white","translate":"item.wooden_hammer"}'
    data modify storage item: Item.tag.display.Lore set value ['{"translate":"item.wooden_hammer.lore","color":"white","italic":false}','{"translate":"item.wooden_hammer.lore.second","color":"white","italic":false}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 1100
...
#ステータスとレア度、耐久値設定
    ...
    scoreboard players set $durability buffer 65
    scoreboard players set $maxdurability buffer 65
...
#実際のステータス
    ...
    data modify storage item: Item.tag.Customnbt.Durability set value 65
    data modify storage item: Item.tag.Customnbt.MaxDurability set value 65
#共通
