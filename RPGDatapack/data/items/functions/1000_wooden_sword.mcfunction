#名前だとか説明文だとか
    ...
    data modify storage item: Item.tag.display.Name set value '{"italic":false,"color":"white","translate":"item.wooden_sword"}'
    data modify storage item: Item.tag.display.Lore set value ['{"translate":"item.wooden_sword.lore","color":"white","italic":false}','{"translate":"item.wooden_sword.lore.second","color":"white","italic":false}']
    ...
    data modify storage item: Item.tag.CustomModelData set value 1000
    data modify storage item: Item.tag.Damage set value 0
    data modify storage item: Item.tag.AttributeModifiers set value [{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-2.4,Operation:0,UUID:[I;266192592,-932362374,-1729792336,-927508933],Slot:"mainhand"},{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:10.19,Operation:0,UUID:[I;-1550551712,2138130775,-1688359397,-1103780835],Slot:"mainhand"}]
...
#ステータスとレア度、耐久値設定
    ...
    scoreboard players set #durability buffer 59
    scoreboard players set #maxdurability buffer 59
...
#実際のステータス
    ...
    data modify storage item: Item.tag.Customnbt.Durability set value 59
    data modify storage item: Item.tag.Customnbt.MaxDurability set value 59
#共通
