...
# 差をminecraft:damageに代入
    ...
    execute unless data entity @s Inventory[{Slot:101b}].components."minecraft:max_damage" run scoreboard players set #max_durability buffer 555
    ...
    item replace entity @s armor.legs from block 0 -59 0 container.0
# リセット
