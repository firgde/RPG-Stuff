...
# custom_dataの耐久値減算
    execute store result score #durability buffer run data get entity @s equipment.feet.components."minecraft:custom_data".Durability
...
# 差をminecraft:damageに代入
    execute store result score #max_durability buffer run data get entity @s equipment.feet.components."minecraft:max_damage"
