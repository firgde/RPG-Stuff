...
# 差をminecraft:damageに代入
    ...
    execute unless data entity @s Inventory[{Slot:103b}].components."minecraft:max_damage" run scoreboard players set #max_durability buffer 407
    ...
    execute unless data entity @s Inventory[{Slot:103b}].components."minecraft:max_damage" run data modify storage item: Item.components."minecraft:max_damage" set value 407
