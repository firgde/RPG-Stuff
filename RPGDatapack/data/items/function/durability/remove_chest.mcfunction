...
# custom_dataの耐久値減算
    execute store result score #durability buffer run data get entity @s Inventory[{Slot:102b}].components."minecraft:custom_data".Durability
...
# 差をminecraft:damageに代入
    ...
    execute unless data entity @s Inventory[{Slot:102b}].components."minecraft:max_damage" run data modify storage item: Item.components."minecraft:max_damage" set value 592
